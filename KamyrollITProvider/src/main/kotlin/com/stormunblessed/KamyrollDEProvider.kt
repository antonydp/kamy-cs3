...
class KamyrollITProvider: MainAPI() {
    companion object {
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse? {
        ...
        val urls = listOf(
            Pair("$krunchyapi/content/v1/browse?locale=it-IT&n=20&sort_by=popularity", "Popular"),
            Pair("$krunchyapi/content/v1/browse?locale=it-IT&n=20&sort_by=newly_added", "Recientes")
        )
    ...
    override suspend fun load(url: String): LoadResponse {
        ...
        getToken()
        getKrunchyToken()
        val metadataUrl = "$krunchyapi/content/v2/cms/series/$fixID?&locale=it-IT"
        ...
        val test = seasonsresponse.items.forEach {
            ...
            it.episodes.forEach {
                ...
                */
                ...
                } else if ((dubTitle!!.contains("Italian") && dub == true)) {
                    dubeps.add(ep)
